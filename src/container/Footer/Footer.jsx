...
const Footer = () => {
  const [formData, setFormData] = useState({ name: '', wmail: '', message: '' });
    ...
    <>
      ...
      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          ...
          <a href='mailto:samuelarmahappiah@gmail.com' className='p-text'>samuelarmahappiah@gmail.com</a>
        </div>

        <div className='app__footer-card'>
          <img src={images.mobile} alt='mobile' />
          <a href='tel: +233 244 710 775' className='p-text'>+233 244 710 775</a>
        </div>
      </div>
